...
public static class DebugExtension
{
	...
	public static void DrawLocalCube(Transform transform, Vector3 size, Color color, Vector3 center = default(Vector3))
	{
		...
		Debug.DrawLine(lbb, rbb, color, duration);
		Debug.DrawLine(rbb, lbf, color, duration);
		Debug.DrawLine(lbf, rbf, color, duration);
		Debug.DrawLine(rbf, lbb, color, duration);

		Debug.DrawLine(lub, rub, color, duration);
		Debug.DrawLine(rub, luf, color, duration);
		Debug.DrawLine(luf, ruf, color, duration);
		Debug.DrawLine(ruf, lub, color, duration);

		Debug.DrawLine(lbb, lub, color, duration);
		Debug.DrawLine(rbb, rub, color, duration);
		Debug.DrawLine(lbf, luf, color, duration);
		Debug.DrawLine(rbf, ruf, color, duration);
	}
