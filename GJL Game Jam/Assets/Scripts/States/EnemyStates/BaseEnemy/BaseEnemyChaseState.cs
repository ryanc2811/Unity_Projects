...
public class BaseEnemyChaseState : BaseState
{
    ...
    public override void SetTransitions()
    {
        ...
        {
            new Transition("AttackTarget",new TargetInRange(4f),
            (int)BaseEnemyStates.Attack, StateIndex(),0),
            new Transition("FindTarget",new TargetOutOfRange(8f),
    ...
    {
        return (int)BaseEnemyStates.Chase;
    }
}
