...
public class PlayerMoveState : BaseState,IStateWithCollision
{
    ...
    public override void SetTransitions()
    {
        ...
        {
            new Transition("ToStop",new PlayerStopped(),
            (int)PlayerStates.Idle, StateIndex(),0),
            new Transition("ToJump",new PlayerJumped(),
            (int)PlayerStates.Jump, StateIndex(),0),
        };
    }
    /// <summary>
    ...
    {
        return (int)PlayerStates.Moving;
    }
}
